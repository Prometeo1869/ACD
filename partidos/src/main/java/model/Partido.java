...
public class Partido implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="NOMBRE_EQUIPO_VISITANTE", insertable=false, updatable=false)
	private Equipo equipo1;

	//bi-directional many-to-one association to Equipo
	@ManyToOne
	@JoinColumn(name="NOMBRE_EQUIPO_LOCAL", insertable=false, updatable=false)
	...
	public Partido(long idPartido, BigDecimal puntosLocal, BigDecimal puntosVisitante, String temporada, Equipo equipo1,
			Equipo equipo2) {
	...
	public String toString() {
		return "Partido [idPartido=" + idPartido + ", puntosLocal=" + puntosLocal + ", puntosVisitante="
				+ puntosVisitante + ", temporada=" + temporada + "]\n";
	}
