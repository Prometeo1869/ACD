...
public class Jugadore implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="NOMBRE_EQUIPO", insertable=false, updatable=false)
	...
	public Jugadore(long idJugador, BigDecimal altura, String nombre, BigDecimal peso, String posicion,
			String procedencia, List<Estadistica> estadisticas, Equipo equipo) {
	...
	public String toString() {
		return "Jugadore [idJugador=" + idJugador + ", altura=" + altura + ", nombre=" + nombre + ", peso=" + peso
				+ ", posicion=" + posicion + ", procedencia=" + procedencia + "]\n";
	}
