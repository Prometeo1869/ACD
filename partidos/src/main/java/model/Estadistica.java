...
public class Estadistica implements Serializable {
	...
	public Estadistica(EstadisticaPK id, BigDecimal asistenciasPorPartido, BigDecimal puntosPorPartido,
			BigDecimal rebotesPorPartido, BigDecimal taponesPorPartido, Jugadore jugadore) {
		this.id = id;
	...
	public String toString() {
		return "Estadistica [id=" + id + ", asistenciasPorPartido=" + asistenciasPorPartido + ", puntosPorPartido="
				+ puntosPorPartido + ", rebotesPorPartido=" + rebotesPorPartido + ", taponesPorPartido="
				+ taponesPorPartido + "]\n";
	}
